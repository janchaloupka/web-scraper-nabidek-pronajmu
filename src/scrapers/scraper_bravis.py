...
class ScraperBravis(ScraperBase):
    ...
    query_url = "https://www.bravis.cz/pronajem-bytu?typ-nemovitosti-byt+3=&typ-nemovitosti-byt+4=&typ-nemovitosti-byt+5=&typ-nabidky=pronajem-bytu&lokalita=cele-brno&vybavenost=nezalezi&q=&action=search&s=1-20-order-0"
    name = "BRAVIS"
